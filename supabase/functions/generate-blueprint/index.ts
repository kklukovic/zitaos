...
CONTEXT: shipping timeframe ${profile.ship_time || profile.time_per_week}, niche/audience ${profile.niche_audience || profile.audience || profile.niche}, customer type ${profile.customer_type}.
